...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Users_1.userModel.findOne({
...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!((!('adminkey' in req.body)) || (keys_1.setings.adminkey === req.body.adminkey))) return [3 /*break*/, 8];
                    return [4 /*yield*/, Users_1.userModel.findOne({ email: req.body.email.toLowerCase() })];
                case 1:
